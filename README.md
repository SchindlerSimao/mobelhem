...
The `words.csv` file is generated by a reproducible scraper pipeline in `scripts/`. See [scripts/README.md](scripts/README.md) for details on:

- Data sources (lar5.com, Wikidata SPARQL, Wikipedia API)
- Pipeline steps (fetch → parse → cities → geo → build)
...
AI agents were used during development to:
- Document the codebase
- Create prototypes to accelerate development and generate repetitive code
- Refactor and optimize existing code

All architectural decisions, analysis, adaptation, and validation were performed by the developers.
